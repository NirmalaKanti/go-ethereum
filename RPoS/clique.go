...
//soni
          ...
          if c.reputationScore>0.55 {
          
         fmt.Println("before",c.stake)
          c.stake = c.stake - (c.stake * 3/4)
          fmt.Println("Downgrading This Node and not allowed to select as miner")
          fmt.Println("After", c.stake)
          c.malicious = false
          return err
          }
          
          if c.reputationScore>0.4 {
          
          fmt.Println("before",c.stake)
          c.stake = c.stake - (c.stake * 1/2)
          fmt.Println("Downgrading This Node not allowed to select as miner")
          fmt.Println("After", c.stake)
          c.malicious = false
          return err
          }
          ...
          if c.reputationScore>0.15 {
          
          fmt.Println("before",c.stake)
          c.stake = c.stake - (c.stake * 1/4)
          fmt.Println("Downgrading This Node and allowed ")
          fmt.Println("After", c.stake)
          c.malicious = false
          }
